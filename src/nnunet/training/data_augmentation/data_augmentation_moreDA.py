...
def get_moreDA_augmentation(dataloader_train, dataloader_val, patch_size, params=default_3D_augmentation_params,
    ...
    """
    1、丢弃弹性变换
    2、增加高斯噪声(GaussianNoiseTransform), 高斯模糊(GaussianBlurTransform)
    3、增加亮度变换,BrightnessMultiplicativeTransform, BrightnessTransform,
    4、对比度变换, ContrastAugmentationTransform
    5、分辨率变换, SimulateLowResolutionTransform
    """
