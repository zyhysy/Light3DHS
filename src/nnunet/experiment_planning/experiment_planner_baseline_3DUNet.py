...
from common_utils import get_pool_and_conv_props_poolLateV2
from utils import create_lists_from_splitted_dataset
...
class ExperimentPlanner(object):
    ...
    def plan_experiment(self):
        ...
        spacings = self.dataset_properties['all_spacings']   # (1,1,1)
        sizes = self.dataset_properties['all_sizes']   # (64,64,64)

        all_classes = self.dataset_properties['all_classes']  # [1]
        modalities = self.dataset_properties['modalities']  # MRI
    ...
    def run_preprocessing(self, num_threads):
        ...
        preprocessor_class = recursive_find_python_class([join("/home/amax/repository/zyh/My_nnUnet/nnunet", "preprocessing")],
                                                         self.preprocessor_name, current_module="preprocessing")
